...
export default function StudentPlansPage() {
  ...
  const handleDeletePlan = async (planId: string) => {
    ...
    try {
      ...
      // Instantly filter it out of standard runtime layout
  ...
  const handleSubmitAnswer = async (taskId: string) => {
    ...
    try {
      ...
      if (!res.ok) throw new Error("Gemini evaluation synthesis incomplete!");
        ...
        {plans.length === 0 ? (
          ...
          <div className="space-y-12">
            {plans.map((plan) => (
              ...
              >
                {/* ✅ 3. Updated Header with Delete Trash Button */}
                ...
                {/* (Rest of grid tasks render exactly like you had it!) */}
