  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
      {stats.map((stat, i) => (
        <div
          key={i}
          className={`rounded-3xl p-6 shadow-sm border border-gray-100 hover:shadow-lg transition-shadow ${stat.bg}`}
        >
          <div
            className={`w-12 h-12 rounded-2xl bg-linear-to-r ${stat.gradient} flex items-center justify-center mb-4`}
          >
