...
export default function CreateQuestionModal({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const data: any = { title, description, classId, type };
      ...
      if (!res.ok) throw new Error(responseData.error || "Creation failed");
      onSuccess();
      onClose();
      // Reset form
      setTitle("");
      ...
      >
        <div className="p-6">
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-2xl font-bold text-gray-900">Create Question</h2>
            <button
              onClick={onClose}
